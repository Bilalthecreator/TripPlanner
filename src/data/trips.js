...
function activity(id, title, extras = {}) {
  return {
    ...
    category: extras.category ?? 'Sightseeing',
    notes: extras.notes ?? '',
    placeId: extras.placeId ?? null,
    placeName: extras.placeName ?? '',
    cost: extras.cost ?? 0,
    completed: extras.completed ?? false,
    scheduled: extras.scheduled ?? Boolean(extras.startTime || extras.placeId),
    ticketRef: extras.ticketRef ?? null,
  }
}

function day(id, date, activities, title) {
...
export const SEED_TRIPS = [
  {
    ...
    days: [
      day('d1', '2024-10-14', [
        activity('a1', 'Arrive Narita', {
          startTime: '10:00',
          placeId: 'nrt',
          placeName: 'Narita Airport',
          cost: 40,
          scheduled: true,
          category: 'Transit',
          durationMinutes: 90,
        ...
        activity('a2', 'Hotel check-in Shibuya', {
          startTime: '14:00',
          placeId: 'hotel-tyo',
          placeName: 'Shibuya',
          cost: 0,
        ...
        activity('a3', 'Evening ramen walk', {
          startTime: '19:00',
          placeId: 'ramen',
          placeName: 'Shinjuku',
          cost: 35,
      ...
      ], 'Tokyo Arrival & Shinjuku'),
      day('d2', '2024-10-15', [
        activity('a4', 'Meiji Shrine', {
          startTime: '09:00',
          placeId: 'meiji',
      ...
      day('d3', '2024-10-16', [
        activity('a7', 'Shinkansen to Kyoto', {
          startTime: '08:00',
          placeId: 'shinkansen',
      ...
      day('d4', '2024-10-17', [
        activity('a10', 'Sannenzaka & Ninenzaka', {
          startTime: '09:00',
          placeId: 'sannen',
          placeName: 'Higashiyama',
          cost: 0,
          scheduled: true,
          category: 'Sightseeing',
          durationMinutes: 90,
          notes: 'Arrive early for quieter streets and soft morning light.',
          completed: false,
        }),
        activity('a11', 'Kiyomizu-dera', {
          startTime: '11:00',
          placeId: 'kiyomizu',
          ...
          category: 'Cultural',
          durationMinutes: 100,
          notes: 'Temple terrace views over the city canopy.',
          completed: false,
        }),
        activity('a12', 'Tea Ceremony Camellia', {
          startTime: '14:00',
          placeId: 'tea',
          placeName: 'Camellia Tea House',
          cost: 55,
          scheduled: true,
          category: 'Cultural',
          durationMinutes: 75,
          notes: 'Reservation confirmed. Soft seating near the garden.',
          ticketRef: 'CAM-69',
          completed: false,
        }),
        activity('a12b', 'Yasaka Pagoda stroll', {
          startTime: '16:30',
          placeId: 'yasaka',
          placeName: 'Yasaka',
          cost: 0,
      ...
      ], 'Higashiyama Historic Route'),
      day('d5', '2024-10-18', [
        activity('a13', 'Day trip to Nara', {
          startTime: '08:30',
          placeId: 'nara',
          placeName: 'Nara',
          cost: 30,
      ...
      day('d6', '2024-10-19', [
        activity('a16', 'Arashiyama bamboo', {
          startTime: '09:00',
          placeId: 'arashi',
        ...
        activity('a17', 'Philosopher Path', {
          startTime: '14:00',
          placeId: 'path',
          placeName: 'Philosopher Path',
          cost: 0,
          scheduled: true,
          category: 'Sightseeing',
          durationMinutes: 90,
        }),
        activity('a18', 'Kaiseki dinner', {
          startTime: '19:00',
          placeId: 'kaiseki',
          placeName: 'Pontocho',
          cost: 120,
      ...
      day('d8', '2024-10-21', [
        activity('a21', 'Return planning buffer', { category: 'Transit' }),
        activity('a22', 'Departure buffer', { category: 'Transit' }),
      ], 'Wrap & Depart'),
    ],
    expenses: [
